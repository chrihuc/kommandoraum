...
/**
 * Created by christoph on 11/20/15.
 */
public class GoogleMessaging extends MainActivity {
    ...
    public void sendRegistrationIdToBackend(String regid) {
        ...
        String url = "http://192.168.192.10:8080/gcm/register.php";
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair("regId", regid));
        params.add(new BasicNameValuePair("name", android_id));
